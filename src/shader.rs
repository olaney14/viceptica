...
impl Program {
    ...
    pub unsafe fn uniform_2f32(&mut self, loc: &str, value: Vector2<f32>, gl: &glow::Context) {
        let vector_as_slice: [f32; 2] = value.into();
        gl.uniform_2_f32_slice(self.get_uniform_location(loc, gl), &vector_as_slice);
    }
}
